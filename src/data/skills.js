...
const skills = [
    ...
    },
    {
        title: "Frontend",
        skills: [
            { name: "HTML", icon: FaHtml5, level: 70, color: "text-orange-500" },
            { name: "CSS", icon: FaCss3Alt, level: 70, color: "text-blue-500" },
            ...
            { name: "JavaScript", icon: SiJavascript, level: 50, color: "text-yellow-400" },
    ...
    },
    {
        ...
        skills: [
            ...
            { name: "Spring", icon: SiSpring, level: 60, color: "text-green-600" },
    ...
    },
    {
        ...
        skills: [
            ...
            { name: "Docker", icon: FaDocker, level: 60, color: "text-sky-500" }
        ],
    },
];
